...
public class StudentServiceImpl implements StudentService {
    ...
    public Student getStudentByUserId(Long userId) {
        return studentRepository.findByUserId(userId)
                .orElseThrow(() -> new ObjectNotFoundException("Student with userId: '" + userId + "' not found"));
    }
    ...
    public List<StudentDto> getAllStudentByGrades(List<Long> gradeId) {
        List<Student> students = studentRepository.findAllActiveStudentsByGrades(gradeId);
        return studentMapper.toStudentDtoList(students);
    }
