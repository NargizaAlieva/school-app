...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee findByUserId(Long userId) {
        return employeeRepository.findByUserId(userId)
                .orElseThrow(() -> new ObjectNotFoundException("Employee with userId: '" + userId + "' not found"));
    }
    ...
    public List<Long> getHomeClassesId() {
        Employee employee = findByIdEntity(userService.getCurrentUser().getId());
        return employeeRepository.findHomeGradeIdsByEmployeeId(employee.getId());
    }
